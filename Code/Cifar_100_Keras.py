...
model = Sequential()
model.add(Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', input_shape=input_shape))
...
#Checkpoint
checkpoint_path = "/content/drive/My Drive/Rete_Cifar100_per_ST/Training_Cifar_100_lite/cp.ckpt"
...
model.save("/content/drive/My Drive/Rete_Cifar100_per_ST/Training_Cifar_100_lite/Cifar_100_lite.h5")     #model.save_weights('model_saved.h5')
print('Model Saved')
